...
@section('auth.content')
    <!--begin::Form-->
    <form class="form w-100" method="post" action="{{ route('auth.login') }}" novalidate="novalidate" id="kt_sign_in_form"
          data-kt-redirect-url="{{ route('admin.index') }}">
        @csrf
        <!--begin::Heading-->
        ...
        <div class="fv-row mb-10">
            <!--begin::Label-->
            <label class="form-label fs-6 fw-bolder text-dark" for="username">نام کاربری شامل شماره موبایل یا
                ایمیل</label>
            <!--end::Label-->
            <!--begin::Input-->
            <input class="form-control form-control-lg form-control-solid" value="{{old('username')}}" type="text"
        ...
        <div class="fv-row mb-10">
            ...
            <div class="d-flex flex-stack mb-2">
                <!--begin::Label-->
                <label class="form-label fw-bolder text-dark fs-6 mb-0" for="password">رمز عبور</label>
                <!--end::Label-->
                <!--begin::Link-->
                <a href="{{route('auth.forgot.password.form')}}" class="link-primary fs-6 fw-bolder">رمز عبور خود را فراموش
                    کرده اید ؟</a>
                <!--end::Link-->
            </div>
            <!--end::Wrapper-->
        ...
        <div class="fv-row">
            <div class="d-flex flex-stack mb-2">
                <a href="{{route('auth.login.form.otp')}}" class="link-primary fs-6 fw-bolder">ورود با رمز پویا</a>
            </div>
        </div>
    </form>
    <!--end::Form-->
                    ...
                    i = FormValidation.formValidation(t, {
                        fields: {
                            ...
                            password: {
                                validators: {
                                    notEmpty: {
                                        message: "رمز عبور اجباری می باشد"
                                    }
                                }
                            }
                        },
