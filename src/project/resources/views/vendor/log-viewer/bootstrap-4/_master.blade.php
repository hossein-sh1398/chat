...
<body dir="rtl">
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-10">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item {{ Route::is('log-viewer::logs.list') ? 'active' : '' }}">
                    <a href="{{ route('log-viewer::logs.list') }}" class="nav-link">
                        <i class="fa fa-archive"></i> گزارش ها
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.logs.viewer', ['type' => 'clear']) }}" class="nav-link">
                        <i class="fa fa-trash"></i> پاکسازی خطاها
                    </a>
                </li>
            </ul>
        </div>
