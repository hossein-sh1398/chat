<div class="d-flex justify-content-end mb-10 message-item" id="message-{{ $message->id }}">
<!--begin::Wrapper-->
<div class="d-flex flex-column align-items-end">
    <!--begin::User-->
    <div class="d-flex align-items-center mb-2">
        @if ($canDelete)
            <div class="left-trash-message">
        ...
        <div class="me-3 text-left">
            <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary ms-1">{{ $message->user->name }}</a>
