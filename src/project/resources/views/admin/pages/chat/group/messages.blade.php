...
<div class="card-header" id="kt_chat_messenger_header">
    <!--begin::Title-->
    <div class="pt-20px card-title w-100percent">
        <!--begin::User-->
...
<div class="card-body" id="kt_chat_messenger_body">
    ...
    <!--begin::Messages-->
    <div class="me-n5 pe-5" onscroll="scrollGroupMessageBox(event, '{{ route('admin.chat.group.messages', ['group' => $group->id]) }}', {{ $group->id }})" id="chat-messages-list" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_footer, #kt_chat_messenger_header, #kt_chat_messenger_footer" data-kt-scroll-wrappers="#kt_content, #kt_chat_messenger_body" data-kt-scroll-offset="5px">
        @include('admin.pages.chat.group.message', ['lists' => $lists, 'canDelete' => $canDelete])
    </div>
    <!--end::Messages-->
</div>
<!--end::Card body-->
...
<div class="card-footer pt-4">
    <div class="mb-6 pb-8 bb-1px-gray">
        <input type="hidden" id="active-group-sidebar" value="{{ $group->id }}">
        <form id="form-send-chat-message" action="{{ route('admin.chat.group.send.message', $group->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            <!--begin::Input-->
            <input type="text" autocomplete="off" class="form-control form-control-flush mb-3" name="message" id="chat-message-input" placeholder="چیزی بنویسد..." />
            <!--end::Input-->
            <!--begin:Toolbar-->
