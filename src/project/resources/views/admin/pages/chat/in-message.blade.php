...
<div class="d-flex justify-content-start mb-10">
    ...
    <div class="d-flex flex-column align-items-start">
        ...
        <div class="d-flex align-items-center mb-2">
            ...
            <!--begin::Details-->
            <div class="ms-3">
                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary me-1">{{ $message->fromUser->name  }}</a>
        ...
        <div style="position: relative;">
            @if($message->seen)
                <div class="box-seen">
                    <span class="fa fa-check icon-seen"></span>
                </div>
            @else
                <div class="box-seen">
                    <span class="fa fa-check icon-unseen"></span>
                </div>
            @endif
