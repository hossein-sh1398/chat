<button onclick="readNewMessage()" class="btn btn-sm btn-primary btn-new-message-incoming d-none">پیام جدید</button>
<!--begin::Card header-->
<div class="card-header" id="kt_chat_messenger_header">
    <!--begin::Title-->
    <div class="card-title w-100percent pt-20px">
        <!--begin::User-->
        <div class="d-flex justify-content-between me-3 w-100percent">
            <span class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">{{ $group->title }}</span>
            <button onclick="$('#settings-groups-modal').modal('show')" class="btn btn-warning btn-sm btn-block btn-hover-rise p-2 fs-8 mb-3 {{ $canDelete ? '' : 'd-none' }}"><i class="fas fa-pencil-alt"></i></button>
            <!--begin::Info-->
            <!--end::Info-->
        </div>
        <!--end::User-->
...
<div class="card-body" id="kt_chat_messenger_body">
    ...
    <!--begin::Messages-->
    <div class="me-n5 pe-5" onscroll="scrollChannelMessageBox(event, '{{ route('admin.chat.group.messages', ['group' => $group->id]) }}', {{ $group->id }})" id="chat-messages-list" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_footer, #kt_chat_messenger_header, #kt_chat_messenger_footer" data-kt-scroll-wrappers="#kt_content, #kt_chat_messenger_body" data-kt-scroll-offset="5px">
        @include('admin.pages.chat.channel.message', ['lists' => $lists, 'canDelete' => $canDelete])
    </div>
    <!--end::Messages-->
</div>
<!--end::Card body-->
...
<div class="card-footer pt-4">
    @if ($canDelete)
        <div class="mb-6 pb-8 bb-1px-gray">
            <input type="hidden" id="active-channel-sidebar" value="{{ $group->id }}">
            <form id="form-send-chat-message" action="{{ route('admin.chat.group.send.message', $group->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                <!--begin::Input-->
                <input class="form-control form-control-flush mb-3" autocomplete="off" type="text" name="message" id="chat-message-input" placeholder="چیزی بنویسد..." />
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center me-2">
                        ...
                        <input type="file" name="file" id="file-input" class="d-none" onchange="loadFile(event, 'group')">
                    </div>
                    <!--end::Actions-->
                    <!--begin::Send-->
...
@include('admin.pages.chat.group.modal.setting-modal', ['users' => $users, 'group' => $group, 'groupUser' => $groupUsers])
<!--end::Card footer-->
<script>
    var audioRecorder = {
    ...
    reader.onload = (e) => {
        ...
        let __url = "{{ route('admin.chat.group.send.message', $group->id) }}";
        $.ajax({
            url:__url,
            type:'POST',
            contentType: false,
